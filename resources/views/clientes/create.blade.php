            ...
            <div class="flex justify-between items-center">
                ...
                <div>
                    ...
                    <p class="text-gray-600 text-lg">
                        Registra un nuevo cliente en el sistema del taller
                    </p>
                </div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-4xl mx-auto px-6">
            ...
            <div class="text-center mb-12">
                ...
                <h2 class="text-3xl font-bold text-gray-900 mb-4">INFORMACIÓN DEL CLIENTE</h2>
                <p class="text-gray-600">Complete los datos del nuevo cliente</p>
            </div>
                    ...
                    <div>
                        ...
                        <ul class="text-blue-800 space-y-2">
                            ...
                            <li class="flex items-center">
                                ...
                                Después de crear el cliente podrás agregar sus vehículos
                            </li>
                        </ul>
                    </div>
                </div>
